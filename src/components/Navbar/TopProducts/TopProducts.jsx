...
const ProductData = [
    {
        ...
        img:Img1,
        title:"Casual Wear",
        description:"Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sed ut magnam corporis laborum officia illo, velit voluptates ducimus sit laboriosam ipsum doloribus aperiam iure molestias quae voluptatum dolores reprehenderit eum?"
    },
     {
        id:2,
        img:Img2,
            ...
            {ProductData.map((data)=>(
                <div key={data.id} data-aos="zoom-in" className='rounded-2xl bg-white dark:bg-gray-800  hover:bg-black/80 dark:hover:bg-primary hover:text-white relative shadow-xl duration-300 group max-w-[300px]'>
                    ...
                    <div className='p-4 text-center'>
                        <div className='w-full flex itmems-center justify-center gap-1'>
