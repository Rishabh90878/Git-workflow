  ...
  return (
    <div>
        {orderPopup && (
            ...
            <div className='fixed top-1/2 left-1/2 --translate-x-1/2 -transalte-y-1/2 p-4 shadow-md bg-white dark:bg-gray-900 rounded-md duration-200 w-[300px]'>
            {/* header */}
                <div className='flex items-center justify-beetween'>
                    <div>
                        <h1>Order now</h1>
                    </div>
                    <div><IoCloseOutline className='text-2xl cursor-pointer' onClick={()=>setOrderPopup(false)}/>
                    </div>
        </div>
        {/* Form section */}
        <div className='mt-4'>
            ...
            <div className='flex justify-center'>
                <button className='bg-grsadeint-to-r from-primary to-secondary hover:scale-105 duration-200 text-white py-1 px-4 rounded-full'>Order Now</button>
            </div>
        </div>
            </div>
            </div>
